...
set( structures_unit_test_TESTS [==[New Node is a tail node]==] [==[Empty list has a size of 0]==] [==[Inserting increments size]==] [==[Deleting decrements size when size > 0]==] [==[Default constructed List is Empty]==] [==[Inserting one element makes the list not empty]==] [==[Deleting a list with one element makes it empty]==] [==[Find -readonly returns F if the value is not found]==] [==[Find -readonly returns T if value is found]==])
